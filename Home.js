...
Data.forEach(z => {
    ...
    cards.innerHTML = `
    <div  class="CARDS" >
    <img src="${z.image}"  width="260"/>
    <h2>${z.category}</h2>
    <button class="Adds"><i class="fa-solid fa-cart-shopping"></i>&nbsp;&nbsp;Add</button>
    </div>`
    
    Dairyproducts.append(cards)

    cards.querySelector(".Adds").addEventListener("click",(e)=>
        {
            e.preventDefault();
...
input.addEventListener("keypress",(e)=>
{
   let  inputValue=input.value
    if(e.key=="Enter")
    {
        ...
        const searchData = Data.filter(n =>n.category.toLowerCase() == inputValue.toLowerCase())
...
//     card1.innerHTML = `
//     <div  class="items1">
//     <img src="${x.image}" width="260"/>
//     <h2>${x.category}</h2>
//     <button class="Add1"><i class="fa-solid fa-cart-shopping"></i>&nbsp;&nbsp;Add</button>
//     </div>`
//     let button = card1.querySelector(".Add1");
...
//      </div>
//     <h4>${x.category}</h4>
//     <button class="Add"><i class="fa-solid fa-cart-shopping"></i>&nbsp;&nbsp;Add</button>`

//     let button = card2.querySelector(".Add");
//     button.addEventListener("click", () => {
//         window.location.href = "./Addtocart.html";
//     });

//     Products.append(card2)
// }
// );
